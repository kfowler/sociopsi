...
class VisualPerception:
    ...
    def process_frame(self, frame: NDArray[np.uint8]) -> dict[str, Any]:
        ...
        # Always publish face count (including 0) so TUI stays updated
    ...
    def draw_detections(
        self, frame: NDArray[np.uint8], faces: list[tuple[int, int, int, int]]
    ) -> NDArray[np.uint8]:
