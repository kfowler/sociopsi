"""Entry point for the Socio-Psi agent."""

import argparse
import sys

from sociopsi.agent import JungAgent, run_single
from sociopsi.config import AgentConfig, setup_logging


def main() -> int:
    """Main entry point."""
    parser = argparse.ArgumentParser(
        description="Socio-Psi - A Jungian psyche for silicon consciousness"
    )

    parser.add_argument(
        "--model",
        default="sociopsi-mid",
        help="Ollama model to use (default: sociopsi-mid)",
    )
