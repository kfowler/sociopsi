"""Configuration for the Socio-Psi agent."""
...
def load_system_prompt(model: str) -> str:
    ...
    2. Current directory: sociopsi.modelfile
    3. Home directory: ~/.sociopsi/{model}.modelfile
    ...
    modelfile_paths = [
        ...
        Path.cwd() / "sociopsi.modelfile",
        Path.home() / ".sociopsi" / f"{model}.modelfile",
    ]
...
class AgentConfig:
    ...
    Attributes:
        ...
        model: Ollama model name. Used for archetype voices, ego mediation,
            ...
            llm_provider="ollama". Default: "sociopsi-mid".
        ...
        journal_file: Path to the journal JSONL file.
            Default: ~/.sociopsi/journal.jsonl

        memory_file: Path to the memory JSON file.
            Default: ~/.sociopsi/memory.json

        world_file: Path to the world model JSON file.
            Default: ~/.sociopsi/world.json
    ...
    # Paths
    data_dir: Path = field(default_factory=lambda: Path.home() / ".sociopsi")
    ...
    def __post_init__(self) -> None:
        ...
        config_file = Path.home() / ".sociopsi" / "config.json"
